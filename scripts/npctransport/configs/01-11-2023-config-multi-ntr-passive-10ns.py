...
config.statistics_interval_ns = 5
...
##########################
# Add Passive Molecules: #
##########################

passive_radii = [10,15,20,30,40]
for i in passive_radii:
    IMP.npctransport.add_float_type(config,
                                    number=100,
                                    radius=i,
                                    type_name=f"passive{i}",
                                    interactions=0)
